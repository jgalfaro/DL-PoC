...
#### Figure 2. Graphical simulations. The left-side animation illustrates the attack mode, in which the red train is under adversarial control, seeking to perpetrate a collision with the blue train. The right-side animation illustrates the defense learning mode, with the adversary under control the defender.
